    ...
    <>
      ...
      <section className="h-screen relative flex items-center justify-center overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.pexels.com/photos/1283219/pexels-photo-1283219.jpeg?auto=compress&cs=tinysrgb&w=1600')",
        ...
        <div className="container mx-auto px-4 relative z-10 text-white text-center">
          <h1 className="font-serif text-4xl md:text-6xl font-bold mb-6 drop-shadow-lg">
            ...
            <span className="block text-amber-400">Professional Bartending</span>
          </h1>
          <p className="text-lg md:text-xl max-w-2xl mx-auto mb-8 text-amber-100">
            Elevate your event with our team of expert mixologists and bespoke cocktail experiences
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-amber-900/80 max-w-3xl mx-auto">
              From intimate gatherings to large celebrations, we provide tailored bartending solutions 
              for every occasion.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Expertly crafted signature cocktails using fresh ingredients and premium spirits.",
                image: "https://images.pexels.com/photos/5379762/pexels-photo-5379762.jpeg?auto=compress&cs=tinysrgb&w=1600"
              },
              {
                title: "Full-Service Bar",
                description: "Complete bar setup with professional staff, glassware, and premium spirits.",
                image: "https://images.pexels.com/photos/3566226/pexels-photo-3566226.jpeg?auto=compress&cs=tinysrgb&w=1600"
              },
              {
                title: "Custom Menu Design",
                description: "Personalized cocktail menus designed to match your event theme and preferences.",
      ...
      <section className="py-20 bg-amber-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-amber-900/80 max-w-3xl mx-auto">
              What sets our bartending team apart is our dedication to quality, creativity, and exceptional service.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Our team consists of experienced, certified bartenders with a passion for craft cocktails."
              },
              {
                icon: <Star className="h-10 w-10" />,
                title: "Premium Ingredients",
                description: "We use only the freshest ingredients and top-shelf spirits to create exceptional drinks."
              },
              {
                icon: <Users className="h-10 w-10" />,
                title: "Personalized Service",
                description: "Every event is unique, and we tailor our services to match your specific needs."
              },
              {
                icon: <Calendar className="h-10 w-10" />,
                title: "Seamless Experience",
                description: "From planning to execution, we ensure your event runs smoothly without any hiccups."
              }
            ].map((feature, index) => (
              <div 
                key={index} 
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-amber-200 max-w-3xl mx-auto">
              Don't just take our word for it. Here's what our clients have to say about their experience with Vulpine Bar.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                quote: "The Vulpine Bar team made our wedding reception absolutely unforgettable. The custom cocktails were a huge hit!",
                author: "Sarah & Michael",
                event: "Wedding Reception"
              },
              {
                quote: "Professional, creative, and incredibly accommodating. They went above and beyond to make our corporate event a success.",
                author: "David Chen",
                event: "Corporate Gala"
              },
              {
                quote: "From the beautiful presentation to the delicious drinks, everything was perfect. We're still getting compliments from our guests.",
              ...
              >
                ...
                <p className="mb-6 text-amber-100 italic">"{testimonial.quote}"</p>
                <div>
            ...
            <div className="md:flex items-center">
              <div className="md:w-1/2 p-10 md:p-16">
                ...
                <p className="text-lg text-amber-100 mb-8">
                  Contact us today to discuss how we can create a memorable experience 
                  for you and your guests with our custom bartending services.
                </p>
                <Link 
                  to="/contact"
