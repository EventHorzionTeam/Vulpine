...
import { Check, Coffee, GlassWater, Wine, Users, Calendar, Clock, Utensils } from 'lucide-react';
  ...
  const additionalServices = [
    {
      ...
      description: "Interactive cocktail-making classes for corporate events or private parties",
      icon: <Users />
    },
    {
      title: "Mobile Bar Rental",
      description: "Custom-built, elegant mobile bars that can be set up at any venue",
      icon: <Utensils />
    },
    {
      title: "Event Planning",
      description: "Full-service event planning assistance to coordinate all aspects of your gathering",
      icon: <Calendar />
    },
    {
    ...
    <>
      ...
      <section className="pt-24 pb-16 md:pt-32 md:pb-20 bg-amber-950 text-white relative">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.pexels.com/photos/4667031/pexels-photo-4667031.jpeg?auto=compress&cs=tinysrgb&w=1600')"
          }}
        />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-amber-100 mb-8">
              From intimate gatherings to grand celebrations, we offer tailored bartending services 
              to make your event exceptional with craft cocktails and professional service.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-amber-900/80 max-w-3xl mx-auto">
              Choose the perfect package for your event, or contact us for a custom solution tailored to your specific needs.
            </p>
          </div>
              ...
              >
                ...
                <div className="p-8">
                  <div className={`inline-block p-3 rounded-full mb-6 ${
                    pkg.recommended ? 'bg-amber-100 text-amber-600' : 'bg-amber-50 text-amber-700'
                  }`}>
                    {pkg.icon}
                  </div>
                  <h3 className="text-2xl font-bold text-amber-950 mb-2">{pkg.title}</h3>
                  <div className="text-xl font-semibold text-amber-700 mb-4">{pkg.price}</div>
                  <p className="text-amber-900/70 mb-6">{pkg.description}</p>
                  <div className="mb-6">
                    <div className="text-sm text-amber-900/80 mb-2">Recommended for:</div>
                    ...
                    {pkg.features.map((feature, i) => (
                      <li key={i} className="flex items-start">
                        <Check size={18} className={`mr-2 mt-0.5 flex-shrink-0 ${
                          pkg.recommended ? 'text-amber-500' : 'text-amber-600'
                        }`} />
          ...
          <div className="text-center mt-12 text-amber-900/80">
            <p className="mb-4">All packages can be customized to fit your specific requirements.</p>
            <p>
              <Link to="/contact" className="text-amber-700 font-medium hover:text-amber-600 underline">
                Contact us
      ...
      <section className="py-20 bg-amber-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-amber-900/80 max-w-3xl mx-auto">
              Enhance your event with these specialized services to create an even more memorable experience.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-amber-900/80 max-w-3xl mx-auto">
              We make working with us easy and straightforward. Here's how we bring your event to life.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "We'll discuss your event details, guest count, preferences, and budget."
              },
              {
                step: "02",
                title: "Custom Proposal",
                description: "We'll create a tailored package with drink options and service details."
              },
              {
                step: "03",
                title: "Menu Development",
                description: "We'll design a custom cocktail menu that matches your event theme."
              },
              {
                step: "04",
                title: "Flawless Execution",
                description: "On the day of your event, we'll arrive early to set up and provide exceptional service."
              }
            ].map((process, index) => (
      ...
      <section className="py-20 bg-amber-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-amber-900/80 max-w-3xl mx-auto">
              Got questions? We've got answers. Here are some common questions we receive about our services.
            </p>
          </div>
            ...
            {[
              {
                ...
                answer: "We recommend booking at least 4-6 weeks in advance for standard events, and 2-3 months for peak season events (May-September) or holidays. For large events, earlier is always better."
              },
              {
                question: "Do you provide the alcohol or should I purchase it?",
                answer: "We can work either way. We can provide all alcohol, mixers, and garnishes as part of your package, or we can work with client-provided alcohol. If you choose to provide your own, we'll give you a detailed shopping list based on your guest count and menu."
              },
              {
                question: "What areas do you serve?",
                answer: "We primarily serve the greater metropolitan area and surrounding counties. We're also available for travel with additional travel fees for locations beyond our standard service area."
              },
              {
                question: "Can you create custom cocktails for my event?",
                answer: "Absolutely! Custom cocktail creation is one of our specialties. We can design signature drinks that match your event theme, color scheme, or personal preferences."
              },
              {
                question: "What is your cancellation policy?",
                answer: "We require a 50% deposit to secure your date. This deposit is refundable up to 30 days before your event. Cancellations within 30 days of the event are eligible for a partial refund or credit toward a future event, depending on circumstances."
              }
            ].map((faq, index) => (
              <details 
                key={index}
      ...
      <section className="py-16 bg-amber-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-amber-100 max-w-2xl mx-auto mb-8">
            Contact us today to discuss how our bartending services can make your next event unforgettable.
          </p>
          <Link 
            to="/contact"
