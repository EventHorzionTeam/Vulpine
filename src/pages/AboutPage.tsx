...
const AboutPage = () => {
  ...
  //     image:
  //       "https://images.pexels.com/photos/5329043/pexels-photo-5329043.jpeg?auto=compress&cs=tinysrgb&w=1600",
  //   },
  //   {
  //     name: "Sofia Chen",
  ...
  const values = [
    {
      ...
      title: "Excellence",
      description:
        "We strive for excellence in every aspect of our service, from the quality of our ingredients to the presentation of our cocktails.",
    },
    {
      icon: <Heart className="h-8 w-8" />,
      title: "Passion",
      description:
        "Our team is passionate about the art of mixology and dedicated to creating memorable experiences through our craft.",
    },
    {
      icon: <MessageSquare className="h-8 w-8" />,
      title: "Communication",
      description:
        "We believe in clear, open communication with our clients throughout the planning and execution process.",
    },
    {
      icon: <ThumbsUp className="h-8 w-8" />,
      title: "Reliability",
      description:
        "You can count on us to deliver on our promises and exceed your expectations at every event.",
    },
    {
      icon: <Smile className="h-8 w-8" />,
      title: "Hospitality",
      description:
        "We're committed to creating a warm, welcoming atmosphere that puts your guests at ease.",
    },
    {
      icon: <Clock className="h-8 w-8" />,
      title: "Punctuality",
      description:
        "We respect your time and ensure prompt arrival, efficient setup, and timely service throughout your event.",
    },
  ];
    ...
    <>
      ...
      <section className="pt-24 pb-16 md:pt-32 md:pb-20 bg-amber-950 text-white relative">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.pexels.com/photos/274192/pexels-photo-274192.jpeg?auto=compress&cs=tinysrgb&w=1600')",
          }}
        />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-amber-100 mb-8">
              A team of passionate mixologists dedicated to elevating your
              events through exceptional cocktails and professional service.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="md:w-1/2">
              ...
              <div className="space-y-4 text-amber-900/80">
                <p>
                  Vulpine Bar was founded in 2019 with a simple mission: to
                  bring exceptional craft cocktail experiences to events of all
                  sizes. What began as a passion project by our founder,
                  Alexandra Reynolds, quickly grew into a sought-after service
                  for those looking to elevate their gatherings.
                </p>
                <p>
                  After years of working in high-end establishments, Alexandra
                  noticed a gap in the market for truly customized, high-quality
                  mobile bartending services. She assembled a team of
                  like-minded professionals who shared her dedication to the
                  craft and her commitment to exceptional service.
                </p>
                <p>
                  Today, Vulpine Bar has become synonymous with creativity,
                  quality, and professionalism in the events industry. We've
                  served at hundreds of events, from intimate dinner parties to
                  grand weddings and corporate galas.
                </p>
                <p>
                  Our name "Vulpine" – meaning fox-like – reflects our clever
                  approach to mixology and our ability to adapt to any
                  environment with grace and skill.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-amber-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-amber-200/80 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {values.map((value, index) => (
              ...
              >
                ...
                <p className="text-amber-900/70">{value.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-amber-100 max-w-3xl mx-auto">
              We take pride in our work and the recognition we've received over
              the years.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-amber-800 to-amber-900 rounded-xl overflow-hidden shadow-xl">
            <div className="p-10 md:p-16 text-center">
              ...
              <p className="text-lg text-amber-100 mb-8 max-w-3xl mx-auto">
                Ready to elevate your next event with our expert bartending
                services? Get in touch to discuss how we can help make your
                vision a reality.
              </p>
              <Link
                to="/contact"
